const Lsi = {
  appName: {
    cs: "Aplikace bcaa05Cookbook",
    en: "Application bcaa05Cookbook",
  },
  ...
  about: {
    header: {
      cs: "O aplikaci bcaa05Cookbook",
      en: "About application bcaa05Cookbook",
    },
    creatorsHeader: {
      cs: "Tvůrci aplikace",
  ...
  unauthInit: {
    buyYourOwn: {
      cs: "Můžete si koupit vlastní bcaa05Cookbook.",
      en: "You can buy your own bcaa05Cookbook.",
    },
    notAuthorized: {
      cs: "Nemáte právo inicializovat tuto aplikaci bcaa05Cookbook.",
      en: "You don't have rights to initialize this bcaa05Cookbook.",
    },
  },
